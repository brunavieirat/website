        ...
        <div data-custom-class="body">
            ...
            <span style={{ color: 'rgb(127, 127, 127)' }}>
              <span style={{ color: 'rgb(89, 89, 89)', fontSize: '15px' }}>
                <span data-custom-class="body_text">
                  ...
                  <span className="question">LOCK IN LLC</span> (doing business
                  as <span className="question">Lock In</span>) (
          ...
          <ul>
            <li data-custom-class="body_text" style={{ lineHeight: 1.5 }}>
              <span style={{ fontSize: '15px' }}>
                ...
                ultimate no-excuses productivity app designed for those who need
                serious discipline to stay focused. This isn’t just another time
                management tool—Lock In forces you to commit by holding you
                accountable with strict time restrictions and real consequences.
              </span>
            </li>
          </ul>
          ...
          <div style={{ lineHeight: '1.5' }}>
            ...
            <ul
              ...
              <li>
                <a
                  href="#infocollect"
                  style={{ color: 'rgb(0, 58, 250)', textDecoration: 'none' }}>
          ...
          <div id="inforetain" style={{ lineHeight: '1.5' }}>
            ...
            <p>
              ...
              your personal information has been stored in backup archives), we
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td
                    ...
                    professional qualisfications if you apply for a job with us
                  </td>
                  <td
                    style={{
                      width: '14.9084%',
          ...
          <div style={{ lineHeight: '1.5' }}>
            ...
            <span style={{ fontSize: '15px' }}>
              ...
              emailing us. We will inform you in writing of any action taken or
