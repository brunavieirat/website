  ...
  return (
     ...
     <span
      style={{
        ...
        height: "2.375rem",
        background:
          "url(data:image/svg+xml;base64,...."
      }}
    ></span>
         ...
         <strong>
           <span style={{ fontSize: '15px' }}>
             <span data-custom-class="subtitle">
               Last updated <span className="question">March 03, 2025</span>
             </span>
           </span>
         </strong>
       </span>
       ...
       <span style={{ color: 'rgb(127, 127, 127)' }}>
         <span style={{ color: 'rgb(89, 89, 89)', fontSize: '15px' }}>
           <span data-custom-class="body_text">
             This Privacy Notice for <span className="question">LOCK IN LLC</span> (doing business as <span className="question">Lock In</span>)
             (<strong>we</strong>, <strong>us</strong>, or <strong>our</strong>), describes how and why we might access, collect, store, use, and/or share
             (<strong>process</strong>) your personal information when you use our services (<strong>Services</strong>), including when you:
           </span>
         </span>
       </span>
     </div>
...
<ul>
       <li data-custom-class="body_text" style={{ lineHeight: 1.5 }}>
         <span style={{ fontSize: '15px', color: 'rgb(89, 89, 89)' }}>
           Download and use our mobile application <span className="question">Lock In</span> or any other application of ours that links to this Privacy Notice.
         </span>
       </li>
     </ul>
...
<div style={{ lineHeight: 1.5 }}>
 ...
 <ul>
       <li data-custom-class="body_text" style={{ lineHeight: 1.5 }}>
         <span style={{ fontSize: '15px' }}>
           Use <span className="question">Lock In</span>. Lock In is the ultimate no-excuses productivity app designed for those who need serious discipline to stay focused.
           This isn’t just another time management tool—Lock In forces you to commit by holding you accountable with strict time restrictions and real consequences.
         </span>
       </li>
     </ul>
      ...
      <div style={{ lineHeight: '1.5' }}>
        ...
        <div style={{ fontSize: '15px' }}>
         <p style={{ color: 'rgb(89, 89, 89)' }}>
          ...
          <h3 style={{ color: 'rgb(0, 0, 0)', fontSize: '15px' }}>
          <strong>Information automatically collected</strong>
          </h3>

        <p style={{ fontSize: '15px', color: 'rgb(89, 89, 89)' }}>
          <strong><em>In Short:</em></strong> Some information — such as your Internet Protocol (IP) address and/or browser and device characteristics — is collected automatically when you visit our Services.
        </p>
        ...
        <ul>
          <li style={{ fontSize: '15px', color: 'rgb(89, 89, 89)' }}>
...
<tr>
      ...
      <ul>
        <li style={{ lineHeight: '1.5', fontSize: '15px' }}>
        ...
        We may use your personal information for our own business purposes, such as for undertaking internal research for technological development and demonstration. This is not considered to be selling of your personal information.
         ...
         <div style={{ lineHeight: '1.5' }}>
            ...
            <ul>
              ...
              <li>
                <strong>Right to opt out</strong> of the processing of your personal data if it is used for targeted advertising, the sale of personal data, or profiling in furtherance of decisions that produce legal or similarly significant effects.
              </li>
            </ul>
  ...
  <div id="policyupdates" style={{ lineHeight: '1.5' }}>
      ...
      <div id="contact" style={{ lineHeight: '1.5' }}>
        ...
        <p style={{ color: 'rgb(89, 89, 89)', fontSize: '15px' }}>LOCK IN LLC</p>
      </div>
