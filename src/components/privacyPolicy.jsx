        ...
        <div
          ...
          <div data-custom-class="body">
              ...
              <strong>
                <span style={{ fontSize: '15px' }}>
                  <span data-custom-class="subtitle">
                    Last updated{' '}
                    <span className="question">March 03, 2025</span>
                  </span>
                </span>
              </strong>
            </span>
              ...
              <span style={{ color: 'rgb(127, 127, 127)' }}>
                <span style={{ color: 'rgb(89, 89, 89)', fontSize: '15px' }}>
                  <span data-custom-class="body_text">
                    ...
                    <span className="question">LOCK IN LLC</span> (doing
                    business as <span className="question">Lock In</span>) (
            ...
            <ul>
              <li data-custom-class="body_text" style={{ lineHeight: 1.5 }}>
                <span style={{ fontSize: '15px', color: 'rgb(89, 89, 89)' }}>
                  ...
                  <span className="question">Lock In</span> or any other
            ...
            <ul>
              <li data-custom-class="body_text" style={{ lineHeight: 1.5 }}>
                <span style={{ fontSize: '15px' }}>
                  Use <span className="question">Lock In</span>. Lock In is the
                  ultimate no-excuses productivity app designed for those who
                  need serious discipline to stay focused. This isn’t just
                  another time management tool—Lock In forces you to commit by
                  holding you accountable with strict time restrictions and real
                  consequences.
                </span>
              </li>
            </ul>
              ...
              <span style={{ fontSize: '15px' }}>
                <span style={{ color: 'rgb(127, 127, 127)' }}>
                  <span data-custom-class="body_text">
                    ...
                    <span className="question">privacy@lockinhq.com</span>.
                  </span>
                </span>
              </span>
            </div>
                ...
                <div id="infouse">
                  ...
                  <ul>
                    ...
                    <li style={{ fontSize: '15px', color: 'rgb(89, 89, 89)' }}>
                      ...
                      may process your information if you choose to use any of
            ...
            <div id="inforetain" style={{ lineHeight: '1.5' }}>
              ...
              <p>
                ...
                we will securely store your personal information and isolate it
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td
                      ...
                      Business contact details in order to provide tou our
                      Services at a business level or job title, work history,
                      and professional qualisfications if you apply for a job
                      with us
                    </td>
                    <td
                      style={{
                  ...
                  <tr>
                    ...
                    <td
                      ...
                      information listed above to create a profile or sumary
                      about, for exmple, an individual's preferences and
                      characteristics
                    </td>
                    <td
                      style={{
            ...
            <div style={{ lineHeight: '1.5' }}>
              ...
              <span style={{ fontSize: '15px', color: 'rgb(89, 89, 89)' }}>
                ...
                <a
                  href="mailto:privacy@lockinhq.com"
                  style={{ color: 'rgb(0, 58, 250)' }}>
                  privacy@lockinhq.com
                </a>
                , or by calling at{' '}
                <a
                  href="tel:1-321-999-1845"
                  style={{ color: 'rgb(0, 58, 250)' }}>
                  1-321-999-1845
                </a>
                .
              ...
              <span style={{ fontSize: '15px' }}>
                ...
                by emailing us. We will inform you in writing of any action
                taken or not taken in response to the appeal, including a
                written explanation of the reasons for the decisions. If your
